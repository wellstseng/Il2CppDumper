...
| Final exists | 21,221 | 有鏡像 Final 檔；其中部分為 placeholder，不代表品質合格 |
| Disk missing | 14,581 | Annotated 有、Final 沒有 |
| Effective completed | 13,547 | 進度表品質口徑；不含 template/stub/strip placeholder |
| Effective remaining | 22,255 | 需要翻譯或重檢後才能算完成 |
